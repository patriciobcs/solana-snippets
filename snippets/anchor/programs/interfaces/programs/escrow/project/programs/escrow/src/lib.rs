// From https://github.com/coral-xyz/anchor/blob/master/tests/escrow/programs/escrow/src/lib.rs
...
pub struct Exchange<'info> {
    /// CHECK: This is the taker's account, not the initializer's.
    #[account(signer)]
    ...
    #[account(mut)]
    pub initializer_receive_token_account: Account<'info, TokenAccount>,
    /// CHECK: This is the initializer's account, not the taker's.
    #[account(mut)]
