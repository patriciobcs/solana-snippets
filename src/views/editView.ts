  ...
  constructor(
    ...
    this._panel = vscode.window.createWebviewPanel(
      ...
      },
      {
        ...
        localResourceRoots: [
          vscode.Uri.file(
            path.join(context.extensionPath, EditView.viewsFolder)
          ),
        ],
      }
    );
    ...
    const htmlTemplate = path.join(
      ...
      EditView.viewsFolder,
      `${viewType}.html`
    );
    this._panel.webview.html = mustache.render(
      fs.readFileSync(htmlTemplate).toString(),
      {
        cspSource: this._panel.webview.cspSource,
        resetCssUri: this._panel.webview.asWebviewUri(
          vscode.Uri.file(
            path.join(
              context.extensionPath,
              EditView.viewsFolder,
        ...
        cssUri: this._panel.webview.asWebviewUri(
          vscode.Uri.file(
            path.join(
              context.extensionPath,
              EditView.viewsFolder,
        ...
        jsUri: this._panel.webview.asWebviewUri(
          vscode.Uri.file(
            path.join(
              context.extensionPath,
              EditView.viewsFolder,
